  ...
  validate() {
    if (this.onEvent) {
      this.field.addEventListener(this.onEvent, e => {
        if (Object(_validators__WEBPACK_IMPORTED_MODULE_0__["requiredField"])(e.target.value)) {
        ...
        console.log('isValid: ', Object(_validators__WEBPACK_IMPORTED_MODULE_0__["requiredField"])(e.target.value));
      });
    }
  }
