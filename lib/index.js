  ...
  validate() {
    if (this.onEvent) {
      this.field.addEventListener(this.onEvent, e => {
        if (!Object(_validators__WEBPACK_IMPORTED_MODULE_0__["requiredField"])(this.field.value)) {
          this.field.classList.add('cat-form-invalid');
        } else {
          this.field.classList.remove('cat-form-invalid');
        }

        console.log('isValid: ', Object(_validators__WEBPACK_IMPORTED_MODULE_0__["requiredField"])(this.field.value));
      });
    }
  }
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: Field, CreateForm, requiredField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
